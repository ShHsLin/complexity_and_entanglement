...
if __name__ == "__main__":
    ...
    if os.path.exists("HPC_data/ED_evolution/"+save_filename+"_evolution.pkl"):
    ...
    for ii in range(int(N_iter/100)):
        ...
        save_obj(data, "HPC_data/circuits_evolution/"+save_filename+f"_depth{depth}_N_iter{N_iter}_circuit")